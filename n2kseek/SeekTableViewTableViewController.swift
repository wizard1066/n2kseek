//
//  SeekTableViewTableViewController.swift
//  n2kseek
//
...
class SeekTableViewTableViewController: UITableViewController {
    
    var listOfPoint2Seek = ["Rule1","Rule2","Rule3"]

    override func viewDidLoad() {
        super.viewDidLoad()
        print("fcuk28052018 \(listOfPoint2Seek)")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print("\(listOfPoint2Seek[indexPath.row])")
        // Configure the cell...
